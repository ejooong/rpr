<?php
// app/Http/Requests/StoreDemplotRequest.php

namespace App\Http\Requests;

use Illuminate\Foundation\Http\FormRequest;

class StoreDemplotRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'kabupaten_id.required' => 'Pilih kabupaten/kota terlebih dahulu', 
            'kecamatan_id.required' => 'Pilih kecamatan terlebih dahulu',
            'desa_id.required' => 'Pilih desa/kelurahan terlebih dahulu',
