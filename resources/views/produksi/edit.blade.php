...
<x-app-layout>
    <x-slot name="header">
        ...
        <p class="text-sm text-gray-600 mt-1">Edit data produksi pertanian</p>
    </x-slot>
        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('produksi.update', $produksi->id) }}" method="POST" id="produksiForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <select name="demplot_id" id="demplot_id" 
                                    ...
                                    @foreach($demplots as $demplot)
                                        <option value="{{ $demplot->id }}" {{ old('demplot_id', $produksi->demplot_id) == $demplot->id ? 'selected' : '' }}>
                            ...
                            <div>
                                ...
                                <select name="komoditas_id" id="komoditas_id" 
                                    ...
                                    @foreach($komoditas as $k)
                                        <option value="{{ $k->id }}" {{ old('komoditas_id', $produksi->komoditas_id) == $k->id ? 'selected' : '' }}>
                                            {{ $k->nama }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <select name="tahun" id="tahun" 
                                    ...
                                    @for($i = date('Y'); $i >= 2020; $i--)
                                        <option value="{{ $i }}" {{ old('tahun', $produksi->tahun) == $i ? 'selected' : '' }}>
                                            {{ $i }}
                                        </option>
                                    @endfor
                                </select>
                            ...
                            <div>
                                ...
                                <select name="bulan" id="bulan" 
                                    ...
                                    @foreach([
                                        ...
                                        <option value="{{ $key }}" {{ old('bulan', $produksi->bulan) == $key ? 'selected' : '' }}>
                                            {{ $value }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <input type="number" name="luas_panen" id="luas_panen" value="{{ old('luas_panen', $produksi->luas_panen) }}" step="0.01" min="0"
                                       class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500" 
                                       required>
                                @error('luas_panen')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            ...
                            <div>
                                ...
                                <input type="number" name="total_produksi" id="total_produksi" value="{{ old('total_produksi', $produksi->total_produksi) }}" step="0.01" min="0"
                                       class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500" 
                                       required>
                            ...
                            <div>
                                ...
                                <input type="number" name="produktivitas" id="produktivitas" value="{{ old('produktivitas', $produksi->produktivitas) }}" step="0.01" min="0" readonly
                            ...
                            <div>
                                ...
                                <input type="date" name="tanggal_input" id="tanggal_input" value="{{ old('tanggal_input', $produksi->tanggal_input->format('Y-m-d')) }}"
                                       class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500" 
                                       required>
                                @error('tanggal_input')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="text" name="sumber_data" id="sumber_data" value="{{ old('sumber_data', $produksi->sumber_data) }}" 
                                       class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                        ...
                        <div class="flex justify-end space-x-3">
                            <a href="{{ route('produksi.show', $produksi->id) }}" class="px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                                Batal
                            </a>
